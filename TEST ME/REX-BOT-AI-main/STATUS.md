...
- K9-Engine not tested end-to-end with GGUF model loading and inference
- Multi-provider failover not verified (K9 -> Ollama -> degraded)
- External provider data sanitization not verified in production
