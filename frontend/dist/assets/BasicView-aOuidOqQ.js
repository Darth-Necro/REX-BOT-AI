import{d as f,j as t,c as O}from"./index-BMXdczKu.js";import{b as x}from"./vendor-Bafxjlbx.js";import"./state-BPa8-Yex.js";const k={awake:"text-rex-safe",patrol:"text-cyan-400",alert_sleep:"text-rex-warn",deep_sleep:"text-rex-muted",off:"text-rex-muted",unknown:"text-rex-warn"},N={awake:"*WOOF WOOF!* REX is awake and protecting your network",patrol:"*ruff ruff* REX is on patrol! *sniff sniff* Inspecting the network...",alert_sleep:"*woof* ... zzz ... REX is sleeping with one ear open",deep_sleep:"*zzz* ... REX is in deep sleep",off:"*whimper* REX is off",unknown:"*ruff?* Connecting to REX backend..."},R={awake:"animate-breathe",patrol:"animate-pulse",alert_sleep:"animate-pulse-slow",deep_sleep:"",off:"opacity-50",unknown:"animate-pulse"},n={normal:`    ^
   / \\__
  (    @\\___
  /         O
 /   (_____/
